#' @title Bootstrap interval estimator
#'
#' @param iter Number of times the experiment is to be repeated
#' @param x The data
...
#' @export
#'
#' @examples \dontrun{myboot2(iter = 10000, x, fun = "mean", alpha = 0.05)}
